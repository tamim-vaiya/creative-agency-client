...
const AddService = () => {
    ...
    const onSubmit = data =>{ 
        ...
        .then(success => {
            if(success) {
                alert('Your Service Published Successfully')
            }
        })
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} >
                            <div className='d-flex' style={servicesStyle}>
                                <div>
                                    ...
                                    <textarea name="description" style={{width:'500px', padding:'20px 10px'}} placeholder='Enter Designation' className='form-control' ref={register({ required: true })} />
                                </div>
                                <div>
